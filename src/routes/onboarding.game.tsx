    ...
    <main className="min-h-screen bg-[#07091A] text-white">
      <div className="mx-auto flex min-h-screen max-w-md flex-col px-6 pb-10 pt-12">
        ...
        <p className="mt-3 text-[14px] text-white/62">
          Step 6 of 8 — placeholder content. The full UI for this step lands in the next iteration.
        </p>
        <div className="mt-auto space-y-3 pt-10">
          <PrimaryButton onClick={() => navigate({ to: "/onboarding/processing" })}>Continue →</PrimaryButton>
